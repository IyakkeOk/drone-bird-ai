...
RESULTS_DIR = os.path.join(SCRIPT_DIR, "results_vit_base")
...
print(f"[INFO] Vision Transformer (ViT-Base) results will be saved to: {RESULTS_DIR}")
...
def plot_confusion_matrix(cm, class_names, save_path):
    ...
    plt.title("Full Confusion Matrix (ViT-Base)")
...
def main():
    SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
    CONFIG_PATH = os.path.join(SCRIPT_DIR, "..", "configs", "cub_vit_base.yaml")
    ...
    print("\nFinal Statistical Summary (ViT-Base):")
